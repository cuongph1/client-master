...
export namespace TienLenCmd {
    ...
    export class ReceiveChatChong extends InPacket {
        uChairWin = 0;
        uChairLost = 0;
        moneyWin=0;
        moneyLost=0;
        ...
        constructor(data: Uint8Array) {
            super(data);
            this.uChairWin = this.getByte();
            this.uChairLost = this.getByte();
            this.moneyWin = this.getLong();
            this.moneyLost = this.getLong();
            this.currentMoneyWin = this.getLong();
            this.currentMoneyLost = this.getLong();
    ...
    export class ReceiveNotifyRegOutRoom extends InPacket {
        outChair = 0;
        isOutRoom = false;
