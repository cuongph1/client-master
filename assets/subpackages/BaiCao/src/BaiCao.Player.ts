...
export default class Player extends cc.Component {
    ...
    showCardName(name) {
        cc.log("AiPoker_Player showCardName name : ", name);
    ...
    processThinking(rate) {
        cc.log("AiPoker_Player processThinking rate : ", rate);
    ...
    fxWin(playerInfo) {
        cc.log("AiPoker_Player fxWin playerInfo : ", playerInfo);
        this.node.children[4].active = true;
    ...
    fxLose(playerInfo) {
        cc.log("AiPoker_Player fxLose playerInfo : ", playerInfo);
        this.node.children[4].active = true;
